...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 47618)), "/Users/nemototakuya/workspace/projects/cards-deck-online/frontend/app/(routes)/page.tsx"],
          
        }]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 68745)), "/Users/nemototakuya/workspace/projects/cards-deck-online/frontend/app/(routes)/layout.tsx"],
          metadata: {
    ...
    const pages = ["/Users/nemototakuya/workspace/projects/cards-deck-online/frontend/app/(routes)/page.tsx"];
    ...
    const originalPathname = "/(routes)/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 30033));
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 89227));
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 48231))
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/nemototakuya/workspace/projects/cards-deck-online/frontend/app/_components/CircleMenu/CircleMenuComponent.tsx`)
...
/* harmony default export */ const CircleMenuComponent = (__default__);
;// CONCATENATED MODULE: ./app/_components/Card/CardsDeck.tsx

const CardsDeck_proxy = (0,module_proxy.createProxy)(String.raw`/Users/nemototakuya/workspace/projects/cards-deck-online/frontend/app/_components/Card/CardsDeck.tsx`)

// Accessing the __esModule property and exporting $$typeof are required here.
// The __esModule getter forces the proxy target to create the default export
// and the $$typeof value is for rendering logic to determine if the module
// is a client boundary.
const { __esModule: CardsDeck_esModule, $$typeof: CardsDeck_$$typeof } = CardsDeck_proxy;
const CardsDeck_default_ = CardsDeck_proxy.default;


/* harmony default export */ const CardsDeck = (CardsDeck_default_);
;// CONCATENATED MODULE: ./app/_components/TopRightButtons/TopRightButtonsComponent.tsx

const TopRightButtonsComponent_proxy = (0,module_proxy.createProxy)(String.raw`/Users/nemototakuya/workspace/projects/cards-deck-online/frontend/app/_components/TopRightButtons/TopRightButtonsComponent.tsx`)

// Accessing the __esModule property and exporting $$typeof are required here.
// The __esModule getter forces the proxy target to create the default export
// and the $$typeof value is for rendering logic to determine if the module
// is a client boundary.
const { __esModule: TopRightButtonsComponent_esModule, $$typeof: TopRightButtonsComponent_$$typeof } = TopRightButtonsComponent_proxy;
const TopRightButtonsComponent_default_ = TopRightButtonsComponent_proxy.default;


/* harmony default export */ const TopRightButtonsComponent = (TopRightButtonsComponent_default_);
;// CONCATENATED MODULE: ./app/_components/PlayBoard.tsx
...
function PlayBoard() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(CardsDeck, {}),
            /*#__PURE__*/ jsx_runtime_.jsx(CircleMenuComponent, {}),
            /*#__PURE__*/ jsx_runtime_.jsx(TopRightButtonsComponent, {})
        ]
    });
}

;// CONCATENATED MODULE: ./app/(routes)/page.tsx


function Home() {
    return /*#__PURE__*/ jsx_runtime_.jsx(PlayBoard, {});
}
...
module.exports = createProxy("/Users/nemototakuya/workspace/projects/cards-deck-online/frontend/node_modules/next/dist/client/image.js");
...
var __webpack_exports__ = __webpack_require__.X(0, [381,191,387,75,380,49], () => (__webpack_exec__(140)));
